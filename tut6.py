...
root.title("My GUI")
d_label = Label(text='''A cybercrime is a crime that involves a computer or a computer network.[1][2] The computer may 
have been used in committing the crime, or it may be the target.[3] Cybercrime may harm someone's security or 
finances.[4][5] 
...
describes cybercrime as the "number one problem with mankind"[6] and said that cybercrime "poses real risks to 
humanity."[7]''', bg="black", fg="white", padx=100, pady=20, font=("comicsansms", 19,"bold"))
d_label.pack()
root.mainloop()
